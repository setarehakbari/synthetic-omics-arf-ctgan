...
# (Optional) raw data paths for building clean UMAP
...
save_figure(p_umap, "Fig2_umap_grids", width = 11, height = 9)  # Slightly wider to make room for subtitles
